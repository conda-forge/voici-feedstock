...
Installing `voici` from the `conda-forge/label/voici_alpha` channel can be achieved by adding `conda-forge/label/voici_alpha` to your channels with:

```
conda config --add channels conda-forge/label/voici_alpha
conda config --set channel_priority strict
```

Once the `conda-forge/label/voici_alpha` channel has been enabled, `voici, voici_core` can be installed with `conda`:
...
```
conda search voici --channel conda-forge/label/voici_alpha
```

or with `mamba`:

```
mamba search voici --channel conda-forge/label/voici_alpha
```
...
mamba repoquery search voici --channel conda-forge/label/voici_alpha

# List packages depending on `voici`:
mamba repoquery whoneeds voici --channel conda-forge/label/voici_alpha

# List dependencies of `voici`:
mamba repoquery depends voici --channel conda-forge/label/voici_alpha
```
